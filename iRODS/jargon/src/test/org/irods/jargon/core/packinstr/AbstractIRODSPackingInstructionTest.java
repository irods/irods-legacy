...
public class AbstractIRODSPackingInstructionTest {
	...
	/**
	 * Test method for {@link org.irods.jargon.core.packinstr.AbstractIRODSPackingInstruction#createKeyValueTag(java.util.List)}.
	 */
	@Test
	public final void testCreateKeyValueTag() throws Exception {
		...
		TestCase.assertEquals("unexpected tag generated for kvp", expectedValue, tag.parseTag());
	}
