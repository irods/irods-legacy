...
public class ModAvuMetadataInpTest {
	...
	public void testInstanceForAddCollectionMetadataNullTarget() throws Exception {
		AvuData avuData = AvuData.instance("attrib", "value", "unit");
		ModAvuMetadataInp.instanceForAddCollectionMetadata(null, avuData);
	}
	
	@Test(expected=JargonException.class)
	public void testInstanceForAddCollectionMetadataBlankTarget() throws Exception {
		AvuData avuData = AvuData.instance("attrib", "value", "unit");
	...
	public void testGetParsedTagsForCollectionAddAvu() throws Exception {
		AvuData avuData = AvuData.instance("attrib", "value", "unit");
		ModAvuMetadataInp modAvu = ModAvuMetadataInp.instanceForAddCollectionMetadata("target", avuData);	
