...
public class AssertionHelperTest {
	...
	public final void testAssertLocalFileExistsInScratchExpectFailure() throws Exception {
	...
	public final void testAssertLocalFileExistsInScratchWhenValid() throws Exception {
		...
		String absolutePathToTestFile = FileGenerator.generateFileOfFixedLengthGivenName(scratchFileSubdir, testFileName, 10);
		AssertionHelper assertionHelper = new AssertionHelper();
	...
	public final void testAssertLocalScratchFileLengthEquals() throws Exception {
		...
		String absolutePathToTestFile = FileGenerator.generateFileOfFixedLengthGivenName(scratchFileSubdir, testFileName, expectedLength);
		AssertionHelper assertionHelper = new AssertionHelper();
	...
	public final void testAssertLocalScratchFileLengthEqualsWhenNotEquals() throws Exception {
		String testFileName = "testassertequals.txt";
		long expectedLength = 15;
		String absolutePathToTestFile = FileGenerator.generateFileOfFixedLengthGivenName(scratchFileSubdir, testFileName, expectedLength + 1);
		AssertionHelper assertionHelper = new AssertionHelper();
		assertionHelper.assertLocalScratchFileLengthEquals(IRODS_TEST_SUBDIR_PATH + "/" + testFileName, expectedLength);
	}
	...
	public final void testAssertExistentIRODSFile() throws Exception {
		AssertionHelper assertionHelper = new AssertionHelper();
		assertionHelper.assertIrodsFileOrCollectionExists(testingPropertiesHelper.buildIRODSCollectionAbsolutePathFromTestProperties(testingProperties, IRODS_TEST_SUBDIR_PATH));
	}
