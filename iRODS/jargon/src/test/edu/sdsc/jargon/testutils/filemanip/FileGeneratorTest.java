...
public class FileGeneratorTest {
	 ...
	 */
	@Test
	public void testGenerateFileOfFixedLength() throws Exception {
		// FIXME add pre and post file checks
		String dir = testProperties
				.getProperty(TestingPropertiesHelper.GENERATED_FILE_DIRECTORY_KEY);
		String fileName = FileGenerator.generateFileOfFixedLength(dir, 200000);
	}
	
	@Test
	public void testGenerateFileOfFixedLengthGivenName() throws Exception {
		...
		FileGenerator.generateFileOfFixedLengthGivenName(absolutePath, testingName, 10);
