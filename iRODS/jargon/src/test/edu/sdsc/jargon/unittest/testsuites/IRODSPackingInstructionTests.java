...
@Suite.SuiteClasses({
  ...
  GenUpdateInpTest.class, ModAvuMetadataInpTest.class, OpenedDataObjInpTest.class, ExecCmdTest.class, StructFileExtAndRegInpTest.class, ExecCmdStreamCloseTest.class
