...
//just overwrite duplicates?
  ...
  /**
   * Gets all of the query results of a particular query and returns them
   * in a single array. Queries with a very large result set could take
   * a excessively long time. Use this method sparingly or make it optional.
   */
    ...
    throws IOException
  {
    if (rl == null) {
      ...
      return (MetaDataRecordList[]) 
              recordLists.toArray(new MetaDataRecordList[0]);
    }
  }
   ...
   * <code>null</code> and is a MetaDataRecordList with all values equal.
   *
   * @param   obj   The object to be compared with this MetaDataRecordList
   *
