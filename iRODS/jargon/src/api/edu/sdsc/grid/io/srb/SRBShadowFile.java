...
public class SRBShadowFile extends SRBRandomAccessFile {
	...
	// ----------------------------------------------------------------------
	/**
	 * This is a SRBFile object instead of a string just to use some of the path
	 * manipulation methods. Obviously it does not point to a real file, (that
	 * is the point of <code>this</code> SRBShadowFile object.)
	 */
	 ...
	 * 
	 * @param file
	 *            the SRB abstract filepath
	 * @param shadowPath
	 *            the shadow path
	 * @throws IOException
	 *             If an I/O error occurs
	 * @throws FileNotFoundException
	 *             If the file exists but is a regular file rather than a shadow
	 *             object, or cannot be opened for any other reason.
	 ...
	 * 
	 * @param parent
	 *            a parent abstract shadow filepath
	 * @param child
	 *            the child shadow path
	 * @throws IOException
	 *             If an I/O error occurs
	 * @throws FileNotFoundException
	 *             If the file exists but is a regular file rather than a shadow
	...
	protected void open(GeneralFile file) throws IOException {
		...
		fd = fileSystem.srbObjOpen(file.getName() + "&SHADOW=" + shadowPath,
	 ...
	 * 
	 * <p>
	 * Truncating a file on the SRB Shadow Fileis not supported, so an
