...
/**
 * Contains immutable metadata values and values that identify the domain (Resource, Collection, etc) that is associated with the metadata values
 * @author Mike Conway - DICE (www.irods.org)
 */
public final class MetaDataAndDomainData extends IRODSDomainObject {

	public enum MetadataDomain {RESOURCE, USER, DATA, COLLECTION}
	 ...
	 * @param metadataDomain <code>MetadataDomain</code> enum value that indicates the domain (RESOURCE, USER, etc) that this
	 * metadata applies to
	 * @param domainObjectId <code>String</code> represents the unique id value for this domain object in ICAT
	 * @param domainObjectUniqueName <code>String</code> with the unique name in ICAT, such as absolute path or resource name
	 * @param avuAttribute <code>String</code> with the AVU attribute
	 * @param avuValue <code>String</code> with the AVU value
	 * @param avuUnit <code>String</code> with the AVU units
	 * @return <code>MetaDataAndDomainData</code> representing an AVU for the given domain
	 * @throws JargonException
	 */
	public static MetaDataAndDomainData instance(MetadataDomain metadataDomain, String domainObjectId, String domainObjectUniqueName, String avuAttribute,
			String avuValue, String avuUnit) throws JargonException {
	...
	private MetaDataAndDomainData(MetadataDomain metadataDomain, String domainObjectId, String domainObjectUniqueName, String avuAttribute,
			String avuValue, String avuUnit) throws JargonException {
