...
/**
 * Defines the interface for a factory to create access objects for IRODS.  Access object are a concept in the newer jargon-core API, and 
 * the intent is not to re-implement all of these capabilities in jargon-trunk.  The access objects here in jargon-trunk are meant to aid in transition to the
 * new API, and to help in eventual refactoring.  
 * 
...
public interface IRODSAccessObjectFactory {
	...
	/**
	 * Get an access object to do bulk file operations (transfer and bundle/unbundle of tar files)
	 * @return
	 * @throws JargonException
	 */
