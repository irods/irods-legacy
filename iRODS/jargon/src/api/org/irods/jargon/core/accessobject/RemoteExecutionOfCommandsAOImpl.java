...
/**
 * Transitional implementation of an access object. This object will process
 * remote execution of commands (scripts) on an iRODS server.
 * 
 * Note that Access Objects are a new feature of the next version of Jargon, and
 * are transitionally implemented in the current release. In this version of
 * Jargon, the access objects are not thread safe.
 * 
 * @author Mike Conway - DICE (www.irods.org)
 * 
 */
public class RemoteExecutionOfCommandsAOImpl extends AbstractIRODSAccessObject
	 ...
	 */
	protected RemoteExecutionOfCommandsAOImpl(final IRODSCommands irodsCommands)
			throws JargonException {
		super(irodsCommands);
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.irods.jargon.core.accessobject.RemoteExecutionOfCommandsAO#
