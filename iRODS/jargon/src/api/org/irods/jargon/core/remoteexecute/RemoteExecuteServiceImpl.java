...
public class RemoteExecuteServiceImpl implements RemoteExecutionService {
	...
	public String toString() {
		...
		sb.append("RemoteExecutionOfCommandsAOImpl");
	 ...
	 */
	public static final RemoteExecutionService instance(final IRODSCommands irodsCommands, final String commandToExecuteWithoutArguments, final String argumentsToPassWithCommand,
	 ...
	 * @param irodsCommands {@link org.irods.jargon.core.connection.IRODSCommands} that will be used to send commands to iRODS.  The connection is used but
	 * not closed or altered.
	 * @param commandToExecuteWithoutArguments <code>String</code> with the name of the command to execute.  Do not put arguments into this field.
	 * @param argumentsToPassWithCommand <code>String</code> that is blank, or has the arguments to send with the given command
	 * @param executionHost <code>String</code> that can optionally point to the host on which the command should be executed.  Blank if not used.
	 * @param absolutePathOfIrodsFileThatWillBeUsedToFindHostToExecuteOn <code>String</code> that can optionally give an iRODS absolute path.  This is used
	 ...
	 * @throws JargonException
	 */
	private RemoteExecuteServiceImpl(IRODSCommands irodsCommands, final String commandToExecuteWithoutArguments, final String argumentsToPassWithCommand,
			final String executionHost, final String absolutePathOfIrodsFileThatWillBeUsedToFindHostToExecuteOn) throws JargonException {
	...
	public InputStream execute() throws JargonException {
		...
		ExecCmd execCmd = ExecCmd.instanceWithHostAndArgumentsToPassParameters(commandToExecuteWithoutArguments, argumentsToPassWithCommand, executionHost, 
				absolutePathOfIrodsFileThatWillBeUsedToFindHostToExecuteOn);
