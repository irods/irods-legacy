...
public class DataObjInp extends AbstractIRODSPackingInstruction {
	...
	/**
	 * Generic instance creation method with all constructor parameters.  In this class are <code>instance()</code> methods
	 * that are specific to the desired operation, and are recommended.  Some of these values are not used in certain protocol operations.
	 * @param fileAbsolutePath <code>String</code> with the file absolute path.
	 * @param createMode <code>int</code> with the create mode.
	 * @param openFlags <code>OpenFlags</code> enum value.
	 * @param offset <code>long</code> with the offset into the data.
	 * @param dataSize <code>long</code> with the data size.
	 * @param numThreads <code> int</code> with the number of threads.
	 * @param resource <code>String</code> with the given resource.
	 ...
	 * @param fileAbsolutePath <code>String</code> with the absolute path to the file/data object to be deleted.
	 * @return <code>DataObjInp</code> containing the necessary packing instruction
	 * @throws JargonException
	 */
	 ...
	 * @param fileAbsolutePath <code>String</code> with the absolute file path to the iRODS file/collection to be moved
	 * @return <code>DataObjInp</code> containing the necessary packing instruction
	 * @throws JargonException
	 */
	 ...
	 * @param fileAbsolutePath <code>String</code> with the absolute path of the irodsFile to replicate
	 * @param resource <code>String</code> of the resource the file should be replicated to.
	 * @return <code>DataObjInp</code> containing the necessary packing instruction
	 * @throws JargonException
	 */
	public static final DataObjInp instanceForReplicate(
		...
		DataObjInp dataObjInp = DataObjInp.instance(fileAbsolutePath, 0, OpenFlags.READ, 0L, 0L, 0, resource);
	...
	/**
	 * Create an instance for replication of a file to a given resource group.  This will replicate to all resources in the resource group.
	 * @param fileAbsolutePath <code>String</code> with the absolute path of the irodsFile to replicate
	 * @param resourceGroup <code>String</code> of the resource group to which the file will be replicated.  (Replicates to all members of the group).
	 * @return <code>DataObjInp</code> containing the necessary packing instruction
	 * @throws JargonException
	 */
	public static final DataObjInp instanceForReplicateToResourceGroup(
		...
		DataObjInp dataObjInp = DataObjInp.instance(fileAbsolutePath, 0, OpenFlags.READ, 0L, 0L, 0, resourceGroup);
		dataObjInp.operationType = REPLICATE_OPERATION_TYPE;
		dataObjInp.setApiNumber(REPLICATE_API_NBR);
	 ...
	 * @param fileAbsolutePath <code>String</code> with the absolute path of the irodsFile to move
	 * @param resource <code>String</code> of the resource the file should be moved to.
	 * @throws JargonException
	 */
	 ...
	 * @param dataObjectAbsolutePath <code>String</code> with the iRODS absolute file path for the data object upon which the checksum
	 * will be calculated.
	 * @return <code>DataObjInp</code> containing the necessary packing instruction
	 * @throws JargonException
	 */
	public static final DataObjInp instanceForDataObjectChecksum(final String dataObjectAbsolutePath) throws JargonException {
		...
		DataObjInp dataObjInp = new DataObjInp(dataObjectAbsolutePath, ZERO_CREATE_MODE, OpenFlags.READ, 0L, 0L, 0, "");
	 ...
	 * @param fileAbsolutePath <code>String</code> with the physical path of the file to open.
	 * @param openFlags <code>OpenFlags</code> enum value.
	 * @return <code>DataObjInp</code> containing the necessary packing instruction
	 * @throws JargonException
	 */
	public static final DataObjInp instanceForOpen(
			final String fileAbsolutePath, OpenFlags openFlags)
			throws JargonException {
	 ...
	 * @param destinationAbsolutePath <code>String</code> with the absolute path to the file
	 * @param length <code>long</code> with the length of the file
	 * @param destinationResource <code>String</code> with the IRODS Resource where the file will be placed.
	 * @return <code>DataObjInp</code> containing the necessary packing instruction
	 * @throws JargonException
	 */
	public static final DataObjInp instanceForPut(final String destinationAbsolutePath, final long length, final String destinationResource, boolean overwrite) throws JargonException {
		...
		DataObjInp dataObjInp = new DataObjInp(destinationAbsolutePath, DEFAULT_CREATE_MODE, OpenFlags.WRITE, 0L, length, 0, destinationResource);
	 ...
	 * @param sourceAbsolutePath <code>String</code> with the absolute path to the file to get
	 * @return <code>DataObjInp</code> containing the necessary packing instruction
	 * @throws JargonException
	 */
	public static final DataObjInp instanceForGet(final String sourceAbsolutePath) throws JargonException {
		if (sourceAbsolutePath == null || sourceAbsolutePath.isEmpty()) {
			throw new JargonException("null or empty sourceAbsolutePath");
		}
		
		DataObjInp dataObjInp = new DataObjInp(sourceAbsolutePath, 0, OpenFlags.READ, 0L, 0L, 0, "");
	...
	/**
	 * Create the proper packing instruction for a get operation specifying a resource
	 * @param sourceAbsolutePath <code>String</code> with the absolute path to the file to get
	 * @param resource <code>String</code> with the resource that contains the file that should be retrieved
	 * @return <code>DataObjInp</code> containing the necessary packing instruction
	 * @throws JargonException
	 */
	public static final DataObjInp instanceForGetSpecifyingResource(final String sourceAbsolutePath, String resource) throws JargonException {
		...
		DataObjInp dataObjInp = new DataObjInp(sourceAbsolutePath, 0, OpenFlags.READ, 0L, 0L, 0, resource);
		dataObjInp.operationType = GET_OPERATION_TYPE;
		dataObjInp.setApiNumber(GET_FILE_API_NBR);
	...
	private DataObjInp(final String fileAbsolutePath,final  int createMode,
			final OpenFlags openFlags, final long offset, final long dataSize, final int numThreads,
	...
	public Tag getTagValue() throws JargonException {
		...
		if (getApiNumber() == PUT_FILE_API_NBR) {
		...
		if (this.getOperationType() == REPLICATE_OPERATION_TYPE && isReplicationToAll()) {
