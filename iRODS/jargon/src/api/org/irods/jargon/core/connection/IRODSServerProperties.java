...
public final class IRODSServerProperties {
	...
	public static final String JARGON_VERSION = "2.3";
	public enum IcatEnabled { ICAT_ENABLED, NO_ICAT }
	...
	public static IRODSServerProperties instance(IcatEnabled icatEnabled, int serverBootTime,
			String relVersion, String apiVersion, String rodsZone) {
		return new IRODSServerProperties(icatEnabled, serverBootTime, relVersion, apiVersion, rodsZone);
	}
	
	private IRODSServerProperties(IcatEnabled icatEnabled, int serverBootTime,
			String relVersion, String apiVersion, String rodsZone) {
		super();
