...
int intChkRechkRecompChkSum4DatObjVol7 (rsComm_t * rsComm, char *strFullDataPath, time_t tTime, ruleExecInfo_t * rei);
int intGetDataObjAVUsVol7 (collInp_t * ptrInpColl, UserDefinedMetadata_t * aAVUarray, int *iTotalAVUs, char *strOut, ruleExecInfo_t * rei);
