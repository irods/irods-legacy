...
/**
 * \fn int msiobjget_irods(msParam_t*  inRequestPath, msParam_t* inFileMode, msParam_t* inFileFlags, msParam_t* inCacheFilename,  ruleExecInfo_t* rei )
 *
 * \brief geting an IRODS object using micro-service drivers
 *
 ...
 * \remark 
 *
 * \note getting irods IRODS object using microservices
 *
 * \usage None
 *
...
/**
 * \fn int msiobjput_irods(msParam_t*  inMSOPath, msParam_t*  inCacheFilename,  msParam_t*  inFileSize, ruleExecInfo_t* rei )
 *
 * \brief putting irods object using micro-service
 *
 * \module msoDrivers_irods
 *
 * \since 3.0
 ...
 * \remark 
 *
 * \note putting irods  object using microservices
 *
 * \usage None
 *
