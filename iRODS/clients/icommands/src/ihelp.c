...
char *icmds[]={
  ...
  "ierror", "iexecmd", "iexit", 
  "ifind",
  "ifsck", "iget", "igetwild.sh", "igroupadmin",
...
"ifind    - search for data-objects/collections in a collection hierarchy.",
...
"ipc      - perform a partial copy to or from an iRODS data-object (file).",
