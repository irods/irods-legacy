...
"Access permissions on collections and data-objects are displayed via the",
"ils -A option.  All users can read all collections (i.e. see data-object",
"names within), unless the administrator has enabled the 'strict' ACL",
"policy (via the acAclPolicy rule).",
" ",
