...
"Usage : ireg -b [-R resource] irodsBundlePath irodsCollection",
" ",
...
" ",
"The -b option can be used to associate a bundle file with a collection.",
"The irods files stored in this collection will be bundlized and stored in",
"the bundle file. The [-R resource] option is used to specify the resource",
"to create the bundle file in case it does not exist.",
"The 'ireg -m unmount' command can be used to disassociate a bundle from a",
"collection",
" ",
"Options are:",
...
" -b  associated a bundle file with a collection",
" -v  verbose",
" -V  Very verbose",
" -h  this help",
""};
