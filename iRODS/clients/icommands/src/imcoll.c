...
{
   char *msgs[]={
"Usage : imcoll [-hCvV] [-D dataType] [-R resource] physicalFilePath",
"               irodsPath",
"Usage : imcoll -m mountType [-R resource] mountDirectory|structuredFilePath",
"               irodsCollection",
"Usage : imcoll -m mountType 'unmount' irodsCollection",
" ",
...
" ",
"    imcoll -C /tmp/src1 /tempZone/home/myUser/src1",
" ",
...
"    imcoll -m mountType 'unmount' /tempZone/home/myUser/mymount",
" ",
" ",
"Options are:",
