...
" ",
"If the mountType is 'm' or 'msso', the first argument is the logical path",
"of a workflow file of type 'msso'. The second argument is the ",
"collection where results of the workflow execution will be stored.",
" ",
