...
"the arguments in line 2 in the -F file, irule will prompt for *A or",
"the user can enter it on the command line: irule -F filename *A=23",
" ",
"An example rule is given in the file:   clients/icommands/test/ruleInp1",
" ",
