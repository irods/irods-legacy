...
program				/* 1 */
	: /* NULL */			{ }
	| program rule_list     	{ print_final($2); }
	;
...
execution_statement
        ...
        | REMOTE '(' identifier ')' statement
					{ $$=stitch(REMOTE,$3,$5,NULL,NULL); }
...
void *stitch(int typ, void *inarg1, void  *inarg2, void  *inarg3, void  *inarg4)
{
  ...
  case REMOTE:
    if ((t = strstr(arg2,":::")) != NULL) {
      *t = '\0';
      sprintf(tmpStr,"remoteExec(%s,%s,%s):::nop", arg1, arg2,(char *) t + strlen(":::"));
      *t = ':';
    }
    else {
      sprintf(tmpStr,"remoteExec(%s,%s,%s):::nop", arg1, arg2,"''");
    }
    break;
  case PARALLEL:
    if ((t = strstr(arg2,":::")) != NULL) {
