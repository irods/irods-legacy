...
insert into R_SPECIFIC_QUERY (alias, sql, create_ts) values ('ls', 'select alias,sql from R_SPECIFIC_QUERY', '01292940000');
insert into R_SPECIFIC_QUERY (alias, sql, create_ts) values ('lsl', 'select alias,sql from R_SPECIFIC_QUERY where sql like ?', '01292940000');
