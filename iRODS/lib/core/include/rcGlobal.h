...
rescTypeDef_t RescTypeDef[] = {
  {"unix",	FILE_CAT, UNIX_FILE_TYPE,  DO_CHK_PATH_PERM, CREATE_PATH, HAS_SIZE_INFO},
  {"hpss",	FILE_CAT, HPSS_FILE_TYPE,  DO_CHK_PATH_PERM, CREATE_PATH, HAS_SIZE_INFO},
  {"windows",   FILE_CAT, NT_FILE_TYPE,    DO_CHK_PATH_PERM, CREATE_PATH, HAS_SIZE_INFO},
  {"test stage",FILE_CAT, TEST_STAGE_FILE_TYPE, DO_CHK_PATH_PERM, CREATE_PATH, HAS_SIZE_INFO},
  {"s3",FILE_CAT, S3_FILE_TYPE, DO_CHK_PATH_PERM, CREATE_PATH, HAS_SIZE_INFO},
  {"MSS universal driver", FILE_CAT, UNIV_MSS_FILE_TYPE,  DO_CHK_PATH_PERM, CREATE_PATH, HAS_SIZE_INFO},
  {"wos",FILE_CAT, WOS_FILE_TYPE, NO_CHK_PATH_PERM, NO_CREATE_PATH, HAS_SIZE_INFO},
  {"database", DB_CAT, 0, 0, NO_CREATE_PATH, NO_SIZE_INFO},
  {"mso",FILE_CAT, MSO_FILE_TYPE, NO_CHK_PATH_PERM, NO_CREATE_PATH, NO_SIZE_INFO},
  {"nonblocking",FILE_CAT, NON_BLOCKING_FILE_TYPE,  DO_CHK_PATH_PERM, CREATE_PATH, HAS_SIZE_INFO},
  {"direct access", FILE_CAT, DIRECT_ACCESS_FILE_TYPE, DO_CHK_PATH_PERM, CREATE_PATH, HAS_SIZE_INFO},
  {"ooici", FILE_CAT, OOICI_FILE_TYPE, NO_CHK_PATH_PERM, NO_CREATE_PATH, NO_SIZE_INFO},
  {"pydap", FILE_CAT, PYDAP_FILE_TYPE, NO_CHK_PATH_PERM, NO_CREATE_PATH, NO_SIZE_INFO},
};
