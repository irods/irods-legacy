...
rescTypeDef_t RescTypeDef[] = {
  {"unix",	FILE_CAT, UNIX_FILE_TYPE,  DO_CHK_PATH_PERM, CREATE_PATH, HAS_SIZE_INFO, INC_PARENT_DIR},
  {"hpss",	FILE_CAT, HPSS_FILE_TYPE,  DO_CHK_PATH_PERM, CREATE_PATH, HAS_SIZE_INFO, INC_PARENT_DIR},
  {"windows",   FILE_CAT, NT_FILE_TYPE,    DO_CHK_PATH_PERM, CREATE_PATH, HAS_SIZE_INFO, INC_PARENT_DIR},
  {"test stage",FILE_CAT, TEST_STAGE_FILE_TYPE, DO_CHK_PATH_PERM, CREATE_PATH, HAS_SIZE_INFO, INC_PARENT_DIR},
  {"s3",FILE_CAT, S3_FILE_TYPE, DO_CHK_PATH_PERM, CREATE_PATH, HAS_SIZE_INFO, INC_PARENT_DIR},
  {"MSS universal driver", FILE_CAT, UNIV_MSS_FILE_TYPE,  DO_CHK_PATH_PERM, CREATE_PATH, HAS_SIZE_INFO, INC_PARENT_DIR},
  {"wos",FILE_CAT, WOS_FILE_TYPE, NO_CHK_PATH_PERM, NO_CREATE_PATH, HAS_SIZE_INFO, INC_PARENT_DIR},
  {"database", DB_CAT, 0, 0, NO_CREATE_PATH, NO_SIZE_INFO, INC_PARENT_DIR},
  {"mso",FILE_CAT, MSO_FILE_TYPE, NO_CHK_PATH_PERM, NO_CREATE_PATH, NO_SIZE_INFO, INC_PARENT_DIR},
  {"nonblocking",FILE_CAT, NON_BLOCKING_FILE_TYPE,  DO_CHK_PATH_PERM, CREATE_PATH, HAS_SIZE_INFO, INC_PARENT_DIR},
  {"direct access", FILE_CAT, DIRECT_ACCESS_FILE_TYPE, DO_CHK_PATH_PERM, CREATE_PATH, HAS_SIZE_INFO, INC_PARENT_DIR},
  {"ooici", FILE_CAT, OOICI_FILE_TYPE, NO_CHK_PATH_PERM, NO_CREATE_PATH, NO_SIZE_INFO, NO_INC_PARENT_DIR},
  {"pydap", FILE_CAT, PYDAP_FILE_TYPE, NO_CHK_PATH_PERM, NO_CREATE_PATH, NO_SIZE_INFO, INC_PARENT_DIR},
  {"erddap", FILE_CAT, ERDDAP_FILE_TYPE, NO_CHK_PATH_PERM, NO_CREATE_PATH, NO_SIZE_INFO, NO_INC_PARENT_DIR},
  {"tds", FILE_CAT, TDS_FILE_TYPE, NO_CHK_PATH_PERM, NO_CREATE_PATH, NO_SIZE_INFO, PHYPATH_IN_DIR_PTR},
};
