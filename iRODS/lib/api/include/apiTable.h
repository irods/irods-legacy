...
apidef_t RcApiTable[] = {
    ...
    {DATA_OBJ_READ_AN, RODS_API_VERSION, REMOTE_USER_AUTH, REMOTE_USER_AUTH, 
       "dataObjReadInp_PI", 0, NULL, 1, (funcPtr) RS_DATA_OBJ_READ},
    {DATA_OBJ_WRITE_AN, RODS_API_VERSION, REMOTE_USER_AUTH, REMOTE_USER_AUTH, 
       "dataObjWriteInp_PI", 1, NULL, 0, (funcPtr) RS_DATA_OBJ_WRITE},
    {DATA_OBJ_CLOSE_AN, RODS_API_VERSION, REMOTE_USER_AUTH, REMOTE_USER_AUTH, 
       "dataObjCloseInp_PI", 0, NULL, 0, (funcPtr) RS_DATA_OBJ_CLOSE},
    ...
    {DATA_OBJ_REPL_AN, RODS_API_VERSION, REMOTE_USER_AUTH, REMOTE_USER_AUTH, 
      "DataObjInp_PI", 0, "TransStat_PI", 0, (funcPtr) RS_DATA_OBJ_REPL},
    {DATA_OBJ_LSEEK_AN, RODS_API_VERSION, REMOTE_USER_AUTH, REMOTE_USER_AUTH,
       "fileLseekInp_PI", 0,"fileLseekOut_PI", 0, (funcPtr) RS_DATA_OBJ_LSEEK},
    {DATA_OBJ_COPY_AN, RODS_API_VERSION, REMOTE_USER_AUTH, REMOTE_USER_AUTH,
       "DataObjCopyInp_PI", 0, "TransStat_PI", 0, (funcPtr) RS_DATA_OBJ_COPY},
    ...
    {RULE_EXEC_DEL_AN, RODS_API_VERSION, REMOTE_USER_AUTH, LOCAL_PRIV_USER_AUTH, 
    ...
    {DATA_OBJ_PHYMV_AN, RODS_API_VERSION, REMOTE_USER_AUTH, REMOTE_USER_AUTH, 
      "DataObjInp_PI", 0, "TransStat_PI", 0, (funcPtr) RS_DATA_OBJ_PHYMV},
    ...
    {BUN_SUB_CREATE_AN, RODS_API_VERSION, REMOTE_USER_AUTH, 
      REMOTE_PRIV_USER_AUTH, "SubFile_PI", 0, NULL, 0, 
      (funcPtr) RS_BUN_SUB_CREATE},
    {BUN_SUB_OPEN_AN, RODS_API_VERSION, REMOTE_USER_AUTH, 
      REMOTE_PRIV_USER_AUTH, "SubFile_PI", 0, NULL, 0, 
      (funcPtr) RS_BUN_SUB_OPEN},
    {BUN_SUB_READ_AN, RODS_API_VERSION, REMOTE_USER_AUTH, 
      REMOTE_PRIV_USER_AUTH, "BunSubFdOpr_PI", 0, NULL, 1, 
      (funcPtr) RS_BUN_SUB_READ},
    {BUN_SUB_WRITE_AN, RODS_API_VERSION, REMOTE_USER_AUTH, 
      REMOTE_PRIV_USER_AUTH, "BunSubFdOpr_PI", 1, NULL, 0, 
      (funcPtr) RS_BUN_SUB_WRITE},
    {BUN_SUB_CLOSE_AN, RODS_API_VERSION, REMOTE_USER_AUTH, 
      REMOTE_PRIV_USER_AUTH, "BunSubFdOpr_PI", 0, NULL, 0, 
      (funcPtr) RS_BUN_SUB_CLOSE},
    {BUN_SUB_UNLINK_AN, RODS_API_VERSION, REMOTE_USER_AUTH, 
      REMOTE_PRIV_USER_AUTH, "SubFile_PI", 0, NULL, 0, 
      (funcPtr) RS_BUN_SUB_UNLINK},
    {BUN_SUB_STAT_AN, RODS_API_VERSION, REMOTE_USER_AUTH, 
      REMOTE_PRIV_USER_AUTH, "SubFile_PI", 0, "RODS_STAT_T_PI", 0, 
      (funcPtr) RS_BUN_SUB_STAT},
    {BUN_SUB_FSTAT_AN, RODS_API_VERSION, REMOTE_USER_AUTH, 
      REMOTE_PRIV_USER_AUTH, "BunSubFdOpr_PI", 0, "RODS_STAT_T_PI", 0, 
      (funcPtr) RS_BUN_SUB_FSTAT},
    {BUN_SUB_LSEEK_AN, RODS_API_VERSION, REMOTE_USER_AUTH, 
      REMOTE_PRIV_USER_AUTH, "BunSubLseekInp_PI", 0, "fileLseekOut_PI", 0, 
      (funcPtr) RS_BUN_SUB_LSEEK},
    {BUN_SUB_RENAME_AN, RODS_API_VERSION, REMOTE_USER_AUTH, 
      REMOTE_PRIV_USER_AUTH, "BunSubRenameInp_PI", 0, NULL, 0, 
      (funcPtr) RS_BUN_SUB_RENAME},
    ...
    {BUN_SUB_MKDIR_AN, RODS_API_VERSION, REMOTE_USER_AUTH, 
      REMOTE_PRIV_USER_AUTH, "SubFile_PI", 0, NULL, 0, 
      (funcPtr) RS_BUN_SUB_MKDIR},
    {BUN_SUB_RMDIR_AN, RODS_API_VERSION, REMOTE_USER_AUTH, 
      REMOTE_PRIV_USER_AUTH, "SubFile_PI", 0, NULL, 0, 
      (funcPtr) RS_BUN_SUB_RMDIR},
    {BUN_SUB_OPENDIR_AN, RODS_API_VERSION, REMOTE_USER_AUTH, 
      REMOTE_PRIV_USER_AUTH, "SubFile_PI", 0, NULL, 0, 
      (funcPtr) RS_BUN_SUB_OPENDIR},
    {BUN_SUB_READDIR_AN, RODS_API_VERSION, REMOTE_USER_AUTH, 
      REMOTE_PRIV_USER_AUTH, "BunSubFdOpr_PI", 0, "RODS_DIRENT_T_PI", 0, 
      (funcPtr) RS_BUN_SUB_READDIR},
    {BUN_SUB_CLOSEDIR_AN, RODS_API_VERSION, REMOTE_USER_AUTH, 
      REMOTE_PRIV_USER_AUTH, "BunSubFdOpr_PI", 0, NULL, 0, 
      (funcPtr) RS_BUN_SUB_CLOSEDIR},
    ...
    {BUN_SUB_TRUNCATE_AN, RODS_API_VERSION, REMOTE_USER_AUTH, 
      REMOTE_PRIV_USER_AUTH, "SubFile_PI", 0, NULL, 0,
      (funcPtr) RS_BUN_SUB_TRUNCATE},
    ...
    {RM_COLL_AN, RODS_API_VERSION, REMOTE_USER_AUTH, REMOTE_USER_AUTH, 
      "CollInp_PI", 0, NULL, 0, (funcPtr) RS_RM_COLL},
